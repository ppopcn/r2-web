...
const I18N = {
  zh: {
    ...
    r2CopyHint: '由于 R2 限制，此操作会重新上传整个文件，大文件耗时较长，请谨慎操作。',
    copyTitle: '复制到',
    copyLabel: '目标路径',
    copyFolderHint: '文件夹将被递归复制，包含所有子文件夹和文件。',
    pathInvalidChars: '路径包含非法字符：{chars}',
    moveTitle: '移动到',
    moveLabel: '目标文件夹',
    moveSamePath: '无法移动：目标文件夹与当前位置相同',
    newFolderTitle: '新建目录',
    newFolderLabel: '目录名称',
  ...
  en: {
    ...
    r2CopyHint: 'Due to R2 limitations, this re-uploads the entire file. Large files may take a while.',
    copyTitle: 'Copy to',
  ...
  ja: {
    ...
    r2CopyHint: 'R2 の制限により、ファイル全体を再アップロードします。大きなファイルは時間がかかる場合があります。',
    copyTitle: 'コピー先',
    copyLabel: 'コピー先パス',
